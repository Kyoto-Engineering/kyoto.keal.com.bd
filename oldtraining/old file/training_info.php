<?php include "inc/header.php";?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">TRAINING ON<br/>INDUSTRIAL AUTOMATION</h2>
				<!-- <img src="img/pic2.jpg" alt="no image" style="background-attachment: fixed; background-size: cover;"> -->
			</div>
		</div>
	</div>
			...
			<div class="col-lg-12">
				...
				<!-- <img src="img/pic2.jpg" alt="no image" style="background-attachment: fixed; background-size: cover;"> -->
							...
							<div class="col-md-4">
								...
								<p>Course Fee: BDT 2,000</p><p>(Refundable)</p></li>
							...
							<div class="col-md-4">
								...
								<li>2. Applicaations of Industrial Automation parts in Industries</li>
								...
								<li>7. Real Life Application of established engineering methods related to industrial automation</li>
